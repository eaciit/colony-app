...
func (a *ApplicationController) SaveApps(r *knot.WebContext) interface{} {
	...
	// if strings.Contains(o.AppPath, "fake") {
	// 	path := strings.Split(o.AppPath, "\\")
	// 	for _, val := range path {
	// 		o.AppPath = val
	// 	}
	// }
	o.AppPath = fmt.Sprintf("%s", filepath.Join(AppBasePath,
		"config", "applications", "dbox.zip"))
